...
import { getTypesByCategory } from '../fn/type/get-types-by-category';
import { GetTypesByCategory$Params } from '../fn/type/get-types-by-category';
...
export class TypeService extends BaseService {
  ...
  /** Path part for operation `getTypesByCategory()` */
  static readonly GetTypesByCategoryPath = '/types/category';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getTypesByCategory()` instead.
   *
   * This method doesn't expect any request body.
   */
  getTypesByCategory$Response(params: GetTypesByCategory$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<TypeResponse>>> {
    return getTypesByCategory(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getTypesByCategory$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getTypesByCategory(params: GetTypesByCategory$Params, context?: HttpContext): Observable<Array<TypeResponse>> {
    return this.getTypesByCategory$Response(params, context).pipe(
